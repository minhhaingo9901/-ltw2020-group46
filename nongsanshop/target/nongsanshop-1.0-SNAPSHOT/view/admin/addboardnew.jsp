              ...
              <div class="card-body">
                ...
                <form action="${pageContext.request.contextPath}/admin/new/add" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <textarea   rows="20" cols="20" id="editor" name="new-content"></textarea>
                  </div>
                  <div class="form-group">
	               ...
	               <div class="form-group">
	                  <label for="input-5">Người đăng</label>
                  <div>
                    <select class="form-control valid" id="input-5" name="new-author" required aria-invalid="false">
